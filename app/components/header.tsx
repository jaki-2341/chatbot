...
export default function Header() {
  ...
  return (
    <header className="bg-white border-b border-slate-200 h-16 shrink-0 z-20">
      <div className="max-w-7xl mx-auto h-full flex items-center justify-between px-0">
        <Link href="/" className="flex items-center gap-2 cursor-pointer">
          <div className="bg-blue-600 text-white p-1.5 rounded-lg">
            <Bot className="w-6 h-6" />
          </div>
          <span className="font-bold text-xl tracking-tight text-slate-900">Proweaver Chatbot Builder</span>
        </Link>
